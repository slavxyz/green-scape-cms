...
const defaultEnglish: UITranslations = {
  ...
  // APOB section
  "apob.title": "АСОЦИАЦИЯ НА ПРОФЕСИОНАЛНИТЕ ОЗЕЛЕНИТЕЛИ В БЪЛГАРИЯ (АПОБ)",
  "apob.description": "Зелено дворче е горд участник в АПОБ, като активно допринася за развитието на бранша чрез внедряване на иновативни решения, високо качество на услугите и отговорно отношение към околната среда. Членството в асоциацията е доказателство за ангажираността на Зелено дворче към професионализъм, устойчивост и непрекъснато усъвършенстване.",
