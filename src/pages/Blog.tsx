      ...
      <main className="flex-1">
        <section className="bg-primary py-16 text-primary-foreground">
          <div className="container text-center">
            <h1 className="font-display text-3xl font-bold md:text-4xl">{t("blog.title")}</h1>
            <p className="mx-auto mt-3 max-w-xl text-primary-foreground/80">{t("blog.subtitle")}</p>
          </div>
        </section>
